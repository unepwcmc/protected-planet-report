...
pa <- read.csv("Z:/f01_projects_active/Global/p08942_Protected_Planet_2024/outputs/3_Coverage/national_stats/b_national_statistics_2020.csv")
oecm <- read.csv("Z:/f01_projects_active/Global/p08942_Protected_Planet_2024/outputs/3_Coverage/national_stats/b_national_statistics_oecm_2020.csv")
...
## write national file
write.csv(pa_oecm, "Z:/f01_projects_active/Global/p08942_Protected_Planet_2024/outputs/3_Coverage/national_stats/pa_oecm_national_2020.csv")
...
write.csv(region_pivot, "Z:/f01_projects_active/Global/p08942_Protected_Planet_2024/outputs/3_Coverage/regional_stats/pa_oecm_regional_2020.csv")
